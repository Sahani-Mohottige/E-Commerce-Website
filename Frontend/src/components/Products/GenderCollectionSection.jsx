      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        {/* Women's Collection */}
         <div className="relative flex-1">
          ...
          />
          <div className="absolute bottom-8 left-8 bg-opacity-90 bg-amber-50
           p-5 rounded-2xl">
            <h2 className="text-3xl font-bold text-gray-900  mb-3">Women's Collection</h2>
        ...
        <div className="relative flex-1">
          ...
          <div className="absolute bottom-8 left-8 bg-opacity-90 bg-amber-50
           p-5 rounded-2xl">
            <h2 className="text-3xl font-bold text-gray-900  mb-3">Men's Collection</h2>
