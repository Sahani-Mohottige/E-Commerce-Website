      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-2xl font-bold text-blue-600 mt-2">
            {orders?.filter((o) => ((o.status || o.orderStatus)?.toLowerCase() === "processing")).length || 0}
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <h3 className="text-sm font-medium text-gray-500">Delivered</h3>
          <p className="text-2xl font-bold text-green-600 mt-2">
            {orders?.filter((o) => ((o.status || o.orderStatus)?.toLowerCase() === "delivered")).length || 0}
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border">
                  ...
                  <tr key={order._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap relative">
                      <button
                        ...
                        className={`inline-flex items-center px-3 py-2 rounded-md text-xs font-medium ${getStatusColor(order.status || order.orderStatus)} relative z-20`}
                      >
