        ...
        {checkout && (
            <div className="space-y-6">
              ...
              <div className="mb-2 text-gray-700 ">
                ...
                <p className="text-lg">Order Date: {new Date(checkout.createdAt).toLocaleDateString()}</p>
              </div>
             <div className="text-sm text-gray-600">
               {/*Estimated Delivery */}
                <p className='text-emerald-700'>Estimated Delivery: {""}
            ...
            <div className="space-y-4">
              {checkout.checkoutItems.map((item)=> {
                return (
                  <div key={item.productId} className="flex items-center mb-4 p-4 rounded-md shadow-sm">
